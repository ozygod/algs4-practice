...
import com.ozygod.Insertion.Shell;
import com.ozygod.Merge.Merge;
import com.ozygod.Merge.MergeBU;
import com.ozygod.Merge.MergeX;
import com.ozygod.PriorityQueue.HeapSort;
import com.ozygod.Quick.Quick;
import com.ozygod.Quick.Quick3way;
import com.ozygod.Quick.QuickX;
import com.ozygod.Selection.Selection;
...
//        else if (alg.equals("Bubble"))          Bubble.sort(a);
        ...
        else if (alg.equals("Heap"))            HeapSort.sort(a);
...
//        int trials = Integer.parseInt(args[3]);
        String alg1 = "MergeX";
        String alg2 = "Merge";
        String args4 = "sorted1";
        int n = 1000000;
        int trials = 100;
        double time1, time2;
        if (args4.equals("sorted")) {
